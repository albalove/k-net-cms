...
<html lang="en">
  ...
  <li class="nav-item">
    <a class="nav-link active font-weight-bold" data-toggle="tab" href="#app">Register</a>
  </li>
</ul>
...
<div class="tab-content">
  ...
  <div style="padding-top:30px;"></div>
	<div class="card">
	<div class="card-header py-2  text-center "><p class="text-primary font-weight-bold h3 ">Please Fill This Form to Create an Account</p></div>
	<div class="card-body bg-light">
			 <div class=""><span></span></div>
			
            <form class="form p-4" role="form" method="POST" action='reg_log.php'>
              <div class="form-group row ">
                ...
                <div class="form-group row">
                    ...
                    <input type="password" class="form-control  rounded-1" name="pass1" pattern=".{6,}" title="Six or more characters" required >
